...
export default function Navbar() {
  return (
    <nav className='flex flex-row items-center md:items-baseline w-full text-white border-b-1 border-neutral-300 px-5 pb-2 justify-between bg-neutral-900 dark:bg-black'>
