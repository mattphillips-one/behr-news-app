    ...
    <aside className="tracking-tight flex justify-between px-3 mb-5">
      <div className="w-full lg:sticky lg:top-20">
        <nav
          ...
          id="nav"
        >
          <a href='/' className={`${fonts.ovo} max-w-[50%] lg:max-w-xs text-xl lg:text-2xl`}>Business Environment & Human Rights News</a>
          <div className="flex flex-row space-x-0">
            ...
            <Link
              key={'/about'}
              href={'/about'}
              className={`${fonts.newsreader} text-lg hover:text-neutral-800 hover:underline dark:hover:text-neutral-200 flex align-middle relative py-1 ml-2 m-1`}
            >
              about
            </Link>
          </div>
