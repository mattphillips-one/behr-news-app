...
export default function Card({ item, descVisibility }: Props) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className={`${fonts.libre_franklin} font-semibold text-neutral-800 text-lg md:text-xl group-hover:text-red-600 group-active:text-red-600 dark:text-neutral-100`}>{item.title}</h2>
      </div>
      <div>
